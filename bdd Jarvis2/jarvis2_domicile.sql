...
INSERT INTO `domicile` VALUES (5,2000,800),(6,1800,200),(14,1994,500);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `jarvis2`.`domicile_AFTER_INSERT` 
AFTER INSERT ON `domicile` FOR EACH ROW
BEGIN
insert into piece(id_domicile)
values (new.id_domicile); 
END */;;
DELIMITER ;
