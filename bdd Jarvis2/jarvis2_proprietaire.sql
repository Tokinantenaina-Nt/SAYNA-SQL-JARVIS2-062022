...
CREATE TABLE `proprietaire` (
  ...
  PRIMARY KEY (`id_pro`),
  KEY `Utilisateur_id_u_idx` (`Utilisateur_id_u`),
  CONSTRAINT `fk_Proprio_Utilisateur` FOREIGN KEY (`Utilisateur_id_u`) REFERENCES `utilisateur` (`id_u`) ON DELETE NO ACTION ON UPDATE NO ACTION
